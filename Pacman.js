var Pacman = function(game, key) {   
    ...
    //  Pacman'i asukoht kaardil - 14x17 ruutu (+8 pikslit tema keskme liigutamiseks)
...
Pacman.prototype.move = function(direction) {
    ...
    //  Taastada esialgne suurus ja suund (Pacman on näoga paremale)
...
Pacman.prototype.update = function() {
    if (!this.isDead) {
        ...
        //  kaardi vaate uuendamine (sõltuvalt asukohast), et leida sobiv suund
...
Pacman.prototype.checkKeys = function(cursors) {
    ...
    {
        //  tuleb klahvi all hoida, et pööraks ümber nurga
        this.turning = Phaser.NONE;
        this.want2go = Phaser.NONE;
    } else {
...
Pacman.prototype.turn = function () {
    ...
    //  vajalik on piirang, sest suures kiirusel mööduvad koordinaadid liiga kiiresti ja siis pole võimalik pöörata ümber nurga 
...
Pacman.prototype.checkDirection = function (turnTo) {
    ...
    {
        //  vale suund, sest on juba pööratud sellesse suunda
        //  või puuduvad kaardi osad või kaardiosa indeks ei ole 1 (põranda osa) 
        return;
    }

    //  kontrollitakse, kas tahab ümber pöörata ja kas saab
