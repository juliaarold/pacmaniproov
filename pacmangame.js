...
PacmanGame.prototype = {
    ...
    init: function () {
        ...
        Phaser.Canvas.setImageRenderingCrisp(this.game.canvas); // retrovaade
    ...
    create: function () {
        ...
        //  Pacman peaks kokkupõrkuma kõigega, välja arvatud 'safetile' (ehk siis 'dots' ja 'pills', vt read 111-113 ka 115-116)
        ...
        // tulemuse tekst
        this.scoreText = game.add.text(8, 272, "Tulemus: " + this.score, { fontSize: "10px", fill: "#fff" });
        this.debugText = game.add.text(375, 260, "", { fontSize: "10px", fill: "#fff" });
        this.overflowText = game.add.text(375, 280, "", { fontSize: "10px", fill: "#fff" });
    ...
    update: function () {
        this.scoreText.text = "Tulemus: " + this.score;
        if (this.DEBUG_ON) {
            this.debugText.text = "Veatest SEES";
        } else {
            this.debugText.text = "";
        }
        if (this.ORIGINAL_OVERFLOW_ERROR_ON) {
            this.overflowText.text = "Ülekate SEES";
        } else {
        ...
        if (!this.pacman.isDead) {
            ...
            if (this.changeModeTimer !== -1 && !this.isPaused && this.changeModeTimer < this.time.time) {
                ...
                console.log("uus mänguviis:", this.TIME_MODES[this.currentMode].mode, this.TIME_MODES[this.currentMode].time);
            }
